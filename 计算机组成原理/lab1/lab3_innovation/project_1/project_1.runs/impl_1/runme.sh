...
HD_PWD='F:/COD/lab1/lab3_innovation/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIB_tube.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIB_tube.tcl -notrace
