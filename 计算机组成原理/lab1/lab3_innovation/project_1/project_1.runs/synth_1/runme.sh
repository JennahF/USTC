...
HD_PWD='F:/COD/lab1/lab3_innovation/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIB_tube.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIB_tube.tcl
