...
#
# Generated by Vivado on Thu Apr 25 22:05:47 +0800 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../paintboard.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../paintboard.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
